    ...
    return (
        <div className="relative flex p-6 mb-2 border-0 rounded-t-inherit rounded-xl bg-gray-50 drop-shadow-md">
            <div className="flex flex-col">
                <h6 className="mb-4 leading-normal text-sm">Campaign - Name - 001</h6>
                <span className="mb-2 leading-tight text-xs">Company Name: <span className="font-semibold text-slate-700 sm:ml-2">Viking Burrito</span>
                </span>
                ...
                <span className="leading-tight text-xs" data-gramm="false" wt-ignore-input="true" data-quillbot-element="UkmbPpTIzu4EqKmwFpoRL">Cost Per Lead: <span className="font-semibold text-slate-700 sm:ml-2">$23.00</span>
                </span>
            </div>
